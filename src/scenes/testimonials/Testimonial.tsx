...
const Testimonial = ({name,image,title,description}: Props) => {
  return (
    ...
    <div className="flex justify-center mb-6">
        <img src={image} className="rounded-full shadow-lg w-32" alt="testimonials"/>
    </div>
    <h5 className="text-lg font-bold mb-4 text-black">{name}</h5>
    <h6 className="font-medium text-primary-500 mb-4">{title}</h6>
        <p className="mb-4">
